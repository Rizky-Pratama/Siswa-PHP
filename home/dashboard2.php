                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-primary" onclick="edit(<?php echo $row['id_siswa'] ?>)" data-toggle="modal" data-target="#exampleModal">Edit</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>NISN</label>
                        <input type="text" id="nisn" placeholder="Masukkan NISN Siswa" class="form-control" readonly value="<?php echo $_SESSION['nisn'] ?>">
                    </div>

                    <div class="form-group">
                        <label>Nama Lengkap</label>
                        <input type="text" id="nama" placeholder="Masukkan Nama Siswa" class="form-control" value="<?php echo $_SESSION['nama'] ?>">
                    </div>

                    <div class="form-group">
                        <label>No HP</label>
                        <input type="number" id="no_telp" placeholder="Masukkan No HP" class="form-control" value="<?php echo $_SESSION['no_telp'] ?>">
                    </div>

                    <div class="form-group">
                        <label>Alamat</label>
                        <textarea class="form-control" id="alamat" placeholder="Masukkan Alamat Siswa" rows="4" style="resize: none;"><?php echo $_SESSION['alamat'] ?></textarea>
                    </div>
                </div>
